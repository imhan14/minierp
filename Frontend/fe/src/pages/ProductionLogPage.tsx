  ...
  return (
    <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Typography sx={{ marginBottom: 2 }}>
        PRODUCTION LOG Lorem ipsum dolor sit amet, consectetur adipiscing elit,
        ...
        adipiscing. Amet nisl suscipit adipiscing bibendum est ultricies integer
        quis. Cursus euismod quis viverra nibh cras. Metus vulputate eu
        ...
        augue. At augue eget arcu dictum varius duis at consectetur lorem. Velit
        sed ullamcorper morbi tincidunt. Lorem donec massa sapien faucibus et
        molestie ac.
      </Typography>
      <Typography sx={{ marginBottom: 2 }}>
